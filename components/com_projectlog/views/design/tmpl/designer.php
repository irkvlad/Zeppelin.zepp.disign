...
<div class="name_project">
    ...
    <p  style="color: #ef4c40"><span>Цвет номера заказа, соответсвует цвету календарика.</span><br>
        <span>Цвет номера заказа, соответсвует цвету календарика.</span><br>
        <span>Цветом календарика показаны рабочие дни по проекту.</span><br><br>
        <span>а) Начало проекта (приступить)-  цвет рамки зависит от цвета проекта календарика</span><br>
        <span>б) Желтая рамка - день первого показа проекта.</span><br>
        <span>в) Красная рамка - день сдачи проекта.</span><br>
        <span>г) Красные ячейки - срок первого показа проекта вышел.</span><br>
        <span>Желтая рамка - день первого показа проекта.</span><br>
        <span>Красные ячейки - срок первого показа проекта вышел.</span><br><br>
