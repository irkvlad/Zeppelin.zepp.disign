    ...
    <script type="text/javascript">
        ...
        function checkForm() {
            ...
            if (document.formvalidator.isValid(form)) {
                ...
                return false;
            } else if (form.disign_date.value == '' || form.disign_date.value == '0000-00-00') {
                alert('<?php echo JText::_('ENTER RELEASE DISIGN DATE'); ?>');
                return false;
                ...
                return false;
            }else if (form.cast_disign.value == '') {
                alert('<?php echo JText::_('ENTER CAST DISIGN'); ?>');
                return false;
            }else if (form.task_id.value == '') {
                alert('<?php echo JText::_('ENTER CAST PROGECT'); ?>');
                return false;
            }
        }
    </script>
                        ...
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td class="key">
                                            <?php echo JText::_('RELEASE NUM'); ?><span style="color:red;">*</span><br/>
                                            <input required type="text" class="inputbox" name="release_id" value="<?php echo $this->project->release_id; ?>"/>
                                        </td>
                                        <td class="key"><?php echo JText::_('PROJECT MANAGER'); ?><span style="color:red;">*</span><br/>
											<?php echo $this->manager_list; ?>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2" class="key">
                                            <?php echo JText::_('TITLE NAME'); ?><span style="color:red;">*</span><br/>
                                            <input name="title" required value="<?php echo $this->escape($this->project->title); ?>" class="inputbox required" type="text" size="50" maxlength="100" />
                                        </td>
                                        <td class="key">
                                            <?php echo JText::_('SHOT TITLE'); ?><br/>
                                            <input name="shot_title"  type="text" value="<?php echo $this->project->shot_title; ?>" title=<?php echo JText::_('SHOT TITLE TITLE'); ?> class="inputbox required" maxlength="15" size="15" />
                                            <?php echo JText::_('SHOT TITLE2'); ?>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td class="key">
                                            <?php echo JText::_('RELEASE DATE'); ?><span style="color:red;">*</span><br/>
